...
const descriptionText = `${BRAND_NAME} is the most trusted smart account wallet on Filecoin.`
...
const MetaTags = ({ prefetchUrl }: { prefetchUrl: string }) => (
  <>
    ...
    {/* Social sharing */}
    <meta name="og:image" content="https://safe.filecoin.io/images/social-share.png" />
    ...
    <meta name="twitter:image" content="https://safe.filecoin.io/images/social-share.png" />
