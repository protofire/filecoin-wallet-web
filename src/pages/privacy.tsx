...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;Filecoin Safe&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a mobile
    ...
    <h4>4.1. When visiting our website and using Filecoin Safe</h4>
    <p>
      When visiting our website or using Filecoin Safe, we may collect and process personal data. The data will be
    ...
    <ol start={4}>
      <li>
        ...
        the Filecoin Safe, we process your
        <ol>
    ...
    <ol start={8}>
      <li>
        When we collect relevant&nbsp;data&nbsp;from the Blockchain to display context information in the Filecoin Safe
        we process:
        <ol>
          <li>your public Wallet address, </li>
          <li>account balance,</li>
    ...
    <p>
      4.2.2 For general operational analysis of the Filecoin Safe interface, monitoring transaction origins and
    ...
    <p>
      In addition, we may take a recording of you while testing Filecoin Safe for internal and external use. The basis
    ...
    <p>
      Filecoin Safe mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the Filecoin Safe mobile app via biometrics information (touch ID or face ID). This
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with Filecoin Safe. For enhanced
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>Filecoin Safe – Privacy policy</title>
      </Head>
